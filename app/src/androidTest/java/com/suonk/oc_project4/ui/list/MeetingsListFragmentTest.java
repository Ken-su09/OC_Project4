...
public class MeetingsListFragmentTest {
    ...
    @Test
    public void click_on_create_new_meeting_should_show_create_new_meeting_root() {
    ...
    @Test
    public void meetings_list_click_on_item_after_creation_should_display_meeting_details_root() {
        onView(allOf(withId(R.id.add_neighbour), isDisplayed())).perform(click());
    ...
    @Test
    public void click_on_item_after_creation_should_display_same_data_that_we_entered_before() {
        onView(allOf(withId(R.id.add_neighbour), isDisplayed())).perform(click());
